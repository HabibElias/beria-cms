...
const books = [
  ...
  },
  {
    ...
    description: "Overwhelmed by a relentless God who pursues us with His love.",
    pages: 208,
  ...
  },
  {
    ...
    description:
      "A masterpiece of religious satire that entertains readers with its sly and ironic portrayal of human life.",
    pages: 175,
    publisher: "HarperOne",
    condition: "Excellent",
    image: "/placeholder.svg?height=200&width=150",
                  ...
                  <Card key={book.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex space-x-2 mt-4">
                        <Button variant="outline" size="sm" className="flex-1" title="View details">
