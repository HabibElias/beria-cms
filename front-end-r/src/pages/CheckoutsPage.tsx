                        ...
                        <TableCell>
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              {checkout.status !== "Returned" && (
                                <div
                                  className={`text-xs ${getDaysRemainingColor(checkout.daysRemaining ?? 0, checkout.status)}`}
                                >
                                  {checkout.status === "Overdue"
                                    ? `${Math.abs(checkout.daysRemaining ?? 0)} days overdue`
                      ...
                      <div className="mt-4 space-y-2">
                        ...
                        {checkout.status !== "Returned" && (
                          <div className="flex justify-between text-xs">
                            ...
                            <span className={getDaysRemainingColor(checkout.daysRemaining ?? 0, checkout.status)}>
                              {checkout.status === "Overdue"
                                ? `${Math.abs(checkout.daysRemaining ?? 0)} days overdue`
                                : `${checkout.daysRemaining} days left`}
                            </span>
